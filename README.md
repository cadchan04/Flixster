...
**Flixster** is a movie browsing app that lets you see different movies and their information, including description and popularity.
...
While building the app, I had difficulties with constraints and AutoLayout.
...
**Flixster Pt. 2** is an app that shows updated and recent movies and some basic information including an overview and vote counts. The app also shows a collection view of movies.
...
I had difficulty making the images from the API display in my own app.
